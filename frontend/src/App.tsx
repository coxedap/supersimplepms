        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          <div className="flex space-x-1 bg-gray-100 p-1 rounded-xl w-fit">
            <button
              ...
              className={`px-4 py-2 text-xs font-bold rounded-lg transition-all ${activeTab === 'focus' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                }`}
            >
              My Workspace
            </button>
            {canViewTeam && (
              <button
                ...
                className={`px-4 py-2 text-xs font-bold rounded-lg transition-all ${activeTab === 'team' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                  }`}
              >
                Team Health
              </button>
